...
def calculate(csv_data):
    """This function is used to store the data in dictionary the number
    of match played in every year in IPL history.
    """
...
def graph_plot(year_names, match_played):
    """This function is used to plot the bar graph of year name by match played."""
