...
def calculate(deliveries_data, matches_data):
    """This function is used to store the match id of 2015 matches in a set and
    by using this set a dictionary stores the economical bowlers in the year 2015 
    and also sorts the dictionary in increasing order. And for calculating economic
    bowler it doesn't considers the super over.
    """
...
def graph_plot(bowler_name, runs):
    """This function is used to plot the bar graph of bowler name by economic runs."""
