...
def calculate(csv_data):
    ...
    of matches won per team per year in IPL history.
    """
...
def graph_plot(matches_won_per_team_per_year):
    """This function is used to plot the stacked bar graph of matches won per team
    per year in IPL history. And also updates the value of bottom height.
    """
